...
<div class="text-center py-5">
    <h2 class="fw-bold">Anggota <span class="text-success">Kacang Berkah</span></h2>
...
<div class="row justify-content-center g-4 mb-4">
    ...
    <div class="col-md-4">
        <div class="card border-0 shadow-sm text-center p-4 h-100">
            ...
            <h6 class="fw-bold mb-1">Maman</h6>
    ...
    <div class="col-md-4">
        <div class="card border-0 shadow-sm text-center p-4 h-100">
            ...
            <h6 class="fw-bold mb-1">sayyid</h6>
...
<div class="row justify-content-center g-4">
    <div class="col-md-4">
        <div class="card border-0 shadow-sm text-center p-4 h-100">
            ...
            <h6 class="fw-bold mb-1">bangopal selep</h6>
